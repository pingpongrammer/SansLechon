          ...
          <div class="compose-email">
            ...
            @endif
                ...
                <div class="inbox-head">
                  <h3 class="input-text">Sent Message</h3>
                  ...
                  <table class="table table-inbox table-hover table-responsive">
                    <tbody>
                      ...
                      @endif
                        ...
                        <td style="width:20%; text-align:center; color:rgb(0, 0, 0)">Sent From:</td>
                        <td style="width:80%; text-align:center; color:rgb(3, 0, 0)">San's Lechon</td>
                        <form action="/sentmessage-view/{{$messages->id}}" enctype="multipart/form-data" method="POST" role="form">
                          @csrf
                          @method('PUT')
