...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow ">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
                <a class="nav-link position-relative text-decoration-none font-weight-bold navbar-toggler border-0 mt-1" href="/login">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-center justify-content-lg-between " id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex  text-center justify-content-lg-between mx-auto ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold" href="/o-about">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold" href="/o-contact">Contact</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled footer-link-list">
                        <li><a class="text-decoration-none text-white" href="/o-home">Home</a></li>
                        <li><a class="text-decoration-none text-white" href="/o-about">About Us</a></li>
                        <li><a class="text-decoration-none text-white" href="/o-contact">Shop Locations</a></li>
                        <li><a class="text-decoration-none text-white" href="/o-contact">Contact</a></li>
                    </ul>
                </div>
