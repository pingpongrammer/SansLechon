...
<body class="bg-orange-50 relative font-roboto font-medium ">
    ...
    <div class="grid">
        ...
        <header  id="header"class="header w-full fixed pl-60 h-14 shadow-md shadow-[#d6987b] bg-white z-200">
            <div class="flex items-center h-14">
                ...
                <div class="flex-1 flex justify-end mr-6 items-center">
                    ...
                    <div class="cursor-pointer relative" onclick="avatarDropdown()">
                        <img class="rounded-full w-9 h-9" src="../assets/img/luffy.jpg" alt="">
        ...
        <div class="sidebar fixed h-screen w-56 shadow-md bg-[#A65B37] shadow-[#A65B37] z-1"  id="sidebar">
            ...
            <div class="flex mt-2 m-3 hover:bg-orange-50 p-2 rounded-lg duration-300 items-center text-orange-50 hover:text-gray-950">
                    ...
                    <div class="w-48">
                        <a href="/adminOrders" class="text-sm">Manage Order</a>
                    </div>
            </div>
            ...
            <div class="flex mt-2 m-3 hover:bg-orange-50 p-2 rounded-lg duration-300 text-orange-50 hover:text-gray-950">
                ...
                <div>
                    <a href="/message" class="text-sm">Messages</a>
                </div>
            </div>
            ...
            <div class="flex mt-2 m-3 hover:bg-orange-50 p-2 rounded-lg duration-300 text-orange-50 hover:text-gray-950">
                ...
                <div class="w-48">
                    <a href="/marketerAccount" class="text-sm">Affiliate Partners</a>
                </div>
            </div>
            ...
            <div class="flex mt-2 m-3 hover:bg-orange-50 p-2 rounded-lg duration-300 text-orange-50 hover:text-gray-950">
                ...
                <div class="w-48">
                    <a href="/customer-requestPayment" class="text-sm">Request Payment</a>
                </div>
            </div>
            ...
            <div class="flex mt-2 m-3 hover:bg-orange-50 p-2 rounded-lg duration-300 text-orange-50 hover:text-gray-950">
                ...
                <div class="w-48">
                    <a href="/customer-registered" class="text-sm">Registered Customers</a>
                </div>
            </div>
            ...
            <div class="flex mt-2 m-3 hover:bg-orange-50 p-2 rounded-lg duration-300 text-orange-50 hover:text-gray-950">
                ...
                <div class="w-48">
                    <a href="/activityLog" class="text-sm">Activity Log</a>
                </div>
            </div>
