...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow ">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
                <a class="nav-link position-relative text-decoration-none font-weight-bold navbar-toggler border-0 mt-1" href="{{$urlLogin}}">
                    <i class="fa fa-fw fa-cart-arrow-down text-dark mr-1"></i>
                    <span class="nav-link position-absolute top-14 left-80 translate-middle badge rounded-pill bg-light text-dark">0</span>
                </a>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-center justify-content-lg-between " id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex  text-center justify-content-lg-between mx-auto ">
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold" href="{{$urlHome}}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold" href="{{$urlAbout}}">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold" href="{{$urlContact}}">Contact</a>
                        </li>
                    </ul>
                </div>
                <div class="navbar justify-content-center align-items-center pl-2 mr-0">
                    <a class="nav-link position-relative text-decoration-none font-weight-bold border-0 d-lg-block d-md-none d-sm-none d-none" href="/login">
                        Cart
                        <i class="fa fa-fw fa-cart-arrow-down text-dark mr-1"></i>
                        <span class="nav-link position-absolute top-14 left-80 translate-middle badge rounded-pill bg-light text-dark">0</span>
                    </a>
                                        
                    <a class="nav-link position-relative text-decoration-none font-weight-bold border-0 d-lg-block " href="/login">
                         Login
                        <i class="fa fa-sign-in text-dark mr-1"></i>
                    </a>
            ...
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled footer-link-list">
                        <li><a class="text-decoration-none text-white" href="{{$urlHome}}">Home</a></li>
                        <li><a class="text-decoration-none text-white" href="{{$urlAbout}}">About Us</a></li>
                        <li><a class="text-decoration-none text-white" href="{{$urlContact}}">Shop Locations</a></li>
                        <li><a class="text-decoration-none text-white" href="{{$urlContact}}">Contact</a></li>
                    </ul>
                </div>
